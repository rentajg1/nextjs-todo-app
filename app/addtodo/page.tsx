    ...
    <div className='flex flex-col h-screen'>
      ...
      <div className='flex items-center justify-center h-screen bg-gray-100'>
        <div className='w-96 p-6 bg-white rounded-2xl'>
          ...
          <form action=''>
            <input placeholder='タイトルを入力' value={title} onChange={(e) => setTitle(e.target.value)} className='mb-4' />
            <textarea placeholder='内容を入力' className='mb-4' onChange={(e) => setContent(e.target.value)}/>
          </form>
